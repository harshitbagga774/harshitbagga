...
os.environ.setdefault("comp4312-hbagga", "comp4312_assignment2_1092015")
# define the app
# Whether the Flask app is run in debugging mode, or not.
DebuggingOn = bool(os.getenv('DEBUG', False))
app = Flask(__name__)
...
def list_files():
    ...
    """
    try:
        bucket_name = request.args.get(
            'bucket_name', default='comp4312_1000', type=str)
        file_names = []
        #####################
        file_names = return_blobs(bucket_name=bucket_name)
        ####################
